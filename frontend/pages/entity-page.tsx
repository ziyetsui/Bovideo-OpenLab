...
export const EntityPage = ({ model }: Readonly<{ model: FrontendEntityModel }>) => {
  ...
  return <div className="page-family page-family--entity" data-qualification={qualification}>
    ...
    <EntityShelf model={model} slot="top_prompts" title={messages.chrome.topPrompts} />
    <EntityShelf model={model} slot="all_prompts" title={messages.chrome.allPrompts} />
    <EntityShelf model={model} slot="facets" title={messages.chrome.facets} />
    <EntityShelf model={model} slot="variables" title={messages.chrome.variables} />
    <EntityShelf model={model} slot="creators" title={messages.chrome.creators} />
    <EntityShelf model={model} slot="evidence" title={messages.chrome.evidence} />
    <EntityShelf model={model} slot="faq" title={messages.chrome.faq} />
    ...
    <EntityShelf model={model} slot="related" title={messages.chrome.related} />
